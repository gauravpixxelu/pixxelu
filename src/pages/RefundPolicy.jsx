        ...
        <div className={'refund-page'}>
            ...
            <section className="privacy-banner">
                <div className="container">
                    <h2 className="hdng-h2">Refund Policy</h2>
                </div>
            </section>
            ...
            <section className="privacy-content">
                <div className="container">
                    <div className="privacy-box">
                        ...
                        <p className="hdng-p">In case the Project or any specific milestone work is canceled by PixxelU , the payments made for the project/milestone can be refunded after deducting USD 15 per hour for the Billable Hours spent on the work performed for the Client including but not limited to the time spent on project discussion, requirements gathering, project planning & documentation, project initiation and execution. After the payments are settled between the two parties – PixxelU must transfer to the Client – all the documents, designs and scripts produced for the Project/milestone are cancelled. <b>Payment mode will be NEFT.</b></p>
